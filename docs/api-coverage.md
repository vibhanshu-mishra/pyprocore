...
DMSA connection profiles add no Procore endpoint coverage. They document a
GC/Owner-installed and authorized private app, permitted projects, credential
environment-variable names, and expected Read Only access to RFIs and
Submittals. The client factory reuses existing client-credentials OAuth.

Profile validation, reports, examples, tests, and CLI commands make no Procore
...
## Released In v2.4.0: Phase 16A Endpoint Notes
...
## Released In v2.4.0: Phase 17A OAS Catalog Notes
...
## Released In v2.4.0: Phase 17B Discovery Router Notes
...
## Released In v2.4.0: Phase 17C Integration Blueprint Notes
...
## Released In v2.4.0: Phase 17D Analytics Recipe Notes
...
## Released In v2.4.0: Phase 17E FastAPI Starter Notes
...
## Released In v2.4.0: Phase 18A API Maintenance Notes
...
groups human-review maintenance tasks, and can plan or copy clearly marked
draft files for likely read-only endpoints.

This is not additional live endpoint coverage and does not prove exact
endpoint support. It does not fetch remote specs, call Procore or external
...
## Released In v2.4.0: Phase 18B Codebase Impact Notes
...
## Released In v2.4.0: Phase 18C Migration Patch Notes
...
diffs are limited to static non-Python CLI/documentation references and are
never applied. The planner does not edit customer files, run git, create
commits or pull requests, fetch remote resources, call Procore or external
AI/model APIs, or enable MCP/tool/write execution.

## Released In v2.4.0: Phase 18D PR Draft Pack Notes
...
optional local artifacts. It does not edit customer files, apply patches, run
...
## Released In v2.4.0: Phase 18E Compatibility Contract Notes
...
## Released In v2.4.0: Phase 18F Migration Guide Notes
