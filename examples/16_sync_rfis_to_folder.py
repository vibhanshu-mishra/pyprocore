"""Sync project RFIs into a local folder tree.
...
def main() -> None:
    """Run the RFI folder sync example."""
    ...
    output_dir = Path(os.getenv("PROCORE_OUTPUT_DIR", "exports")) / "rfi-sync"
