...
from pyprocore.core.client import DEFAULT_TIMEOUT_SECONDS
from pyprocore.core.exceptions import ProcoreAPIError, ValidationError
from pyprocore.core.logger import get_logger, log_exception, structured_message
...
class FileDownloadService:
    ...
    def download_url(
        ...
        *,
        ...
        destination_path = destination_path.with_name(sanitize_filename(destination_path.name))
    ...
    def _write_stream(self, response: requests.Response, destination_path: Path) -> None:
        ...
        try:
            ...
            raise ProcoreAPIError(f"Unable to save attachment {destination_path}: {exc}") from exc
