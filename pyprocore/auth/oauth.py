...
class OAuthClient:
    ...
    def exchange_authorization_code(self, authorization_code: str) -> OAuthTokenResponse:
    ...
    def _request_token(self, payload: dict[str, str]) -> OAuthTokenResponse:
        ...
        try:
            ...
            raise AuthenticationError("OAuth token response was not valid JSON.") from exc
