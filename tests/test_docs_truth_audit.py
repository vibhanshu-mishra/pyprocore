...
class DocsTruthAuditTestCase(unittest.TestCase):
    ...
    def test_roadmap_places_future_items_under_future(self) -> None:
        ...
        self.assertIn("Phase 11D", unreleased_section)
        self.assertIn("Plugin Developer Templates and Pack Scaffolding", unreleased_section)
        self.assertIn("safe local template scaffolding", unreleased_section.lower())
